# Could maybe be translated using https://github.com/bjodah/pycvodes
# but it is not clear if it is worth the effort, as this functionality seems not to be used in the primary functions,
# only in the case study in case1_als.m
